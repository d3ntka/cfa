...
<div id="app">
	<header>
		<nav id="header" class="navbar navbar-expand-lg navbar-dark <?php if ( isset( $navbar_position ) && 'fixed_top' === $navbar_position ) : echo ' fixed-top'; elseif ( isset( $navbar_position ) && 'fixed_bottom' === $navbar_position ) : echo ' fixed-bottom'; endif; if ( is_home() || is_front_page() ) : echo ' home'; endif; ?>">
			<div class="container navbar-container">
			<!-- <div class=""> -->
				<div class="">
					<a class="navbar-brand" href="<?php echo esc_url( site_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
				...
				<div id="navbar" class="collapse navbar-collapse ms-auto">
						<div class="nav-socials">
							<a href="https://twitter.com/CFA_gg" class="">
							...
							<a href="https://www.facebook.com/cfagency" class="">
